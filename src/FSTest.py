...
if args.zt==1:
  ...
  map3=map[['Chr','Position', 'SNP', 'Z(Fst)']]
...
if args.mp==1:
    ...
    print("Suggestive line of Manhattan plot of SNP-based Fst:",sugg3)
...
if args.ztmp==1:
    ...
    print("Suggestive line of Manhattan plot of SNP-based Z(Fst):",sugg3)
    Out['ind'] = range(len(Out))
    Out_grouped = Out.groupby(('Chr'))
    fig_fstsnp = plt.figure()
    ax= plt.gca()
...
if args.zt==2:
    ...
    df4.columns = ['Chr', 'Start_pos','End_pos','Z(Fst)']
...
if args.mp==2:
    ...
    sugg3=sugg2[X].iloc[sugg1]
    print("Suggestive line of Manhattan plot of win-based Fst:",sugg3)
...
if args.ztmp==2:
    ...
    print("Suggestive line of Manhattan plot of win-based Z(Fst):",sugg4)
    df2['ind'] = range(len(df2))
    df2_grouped = df2.groupby(('Chr'))
    fig_fstsnp = plt.figure()
    ax= plt.gca()
